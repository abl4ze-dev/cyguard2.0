...
/** Compatibility-client rendering of the CYGUARD C/G shield and wordmark. */
export const Logo = memo(({ className }: Props) => {
    return (
        ...
        >
            ...
            />
            <path
                d="M20.5 14.1a6 6 0 1 0 0 11.8h4.9v-3.2h-4.6a2.8 2.8 0 1 1 0-5.5h7v-3.1h-7.3Z"
                fill="#F8FAFC"
            />
            <text
                x="45"
            ...
            <defs>
                <linearGradient id="cyguard-gradient" x1="6" y1="4" x2="34" y2="36" gradientUnits="userSpaceOnUse">
